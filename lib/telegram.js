...
// ─── Helpers for determining next onboarding step ────────────────

// Order of onboarding steps after voice extraction
// Returns the state the user should go to next, or 'ready' if complete
...
export { ALLERGIES, SPICE_LEVELS, DIET_TYPES };
